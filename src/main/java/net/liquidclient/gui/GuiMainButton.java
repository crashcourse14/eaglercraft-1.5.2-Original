...
public class GuiMainButton extends Gui {
	...
	public GuiMainButton(int par1, int par2, int par3, String par4Str) {
		this(par1, par2, par3, 200, 20, par4Str);
	}

	public GuiMainButton(int par1, int par2, int par3, int par4, int par5, String par6Str) {
		this.width = 200;
		this.height = 20;
		this.enabled = true;
	...
	private static final TextureLocation tex_gui = new TextureLocation("/gui/LiquidClient/MainGui.png");
